...
EXAMS = [
    ('민사소송법', '56회', 2019, '56회민사소송법[2].pdf', '56회답안(답안포맷)[2].pdf'),
    ('민사소송법', '57회', 2020, '57회민사소송법.pdf', '57회답안(답안포맷).pdf'),
    ('민사소송법', '58회', 2021, '58회민사소송법[3].pdf', '58회답안(답안포맷)[3].pdf'),
    ('민사소송법', '59회', 2022, '59회민사소송법.pdf', '59회답안(답안포맷).pdf'),
